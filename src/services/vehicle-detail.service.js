...
class VehicleDetailService {
   ...
   * Maps all 240+ fields from vehicle_specifications table
   */
  transformVehicleSpecification(spec) {
    ...
    return {
      ...
      make: data.naming_make,
      imageUrl: data.naming_image_url,
      price: data.naming_price,
      onRoadPriceDelhi: data.naming_onroadprice_delhi,

      // Key Data
      keyPrice: data.keydata_key_price,
      keyMileageArai: data.keydata_key_mileage_arai,
      keyEngine: data.keydata_key_engine,
      keyTransmission: data.keydata_key_transmission,
      keyFuelType: data.keydata_key_fueltype,
      keySeatingCapacity: data.keydata_key_seatingcapacity,

      // Engine & Transmission
      engine: data.keydata_key_engine || data.enginetransmission_engine,
      engineType: data.enginetransmission_engine_type,
      topSpeed: data.enginetransmission_top_speed,
      acceleration0To100: data.enginetransmission_acceoeration_0_100_kmph,
      fuelType: data.enginetransmission_fueltype,
      ...
      maxtorqueRpm: data.enginetransmission_maxtorqueRPM,
      performanceOnAlternateFuel: data.enginetransmission_performanceonalternatefuel,
      maxEnginePerformance: data.enginetransmission_maxengineperformance,
      maxMotorPerformance: data.enginetransmission_maxmotorperformance,
      engineTransmissionMileageArai: data.enginetransmission_mileage_arai || data.keydata_key_mileage_arai,
      powerConsumptionMileage: data.enginetransmission_powerconsumptionmileage,
      drivingRange: data.enginetransmission_driving_range,
      ...
      turbochargerSupercharger: data.enginetransm_turbocharger_supercharger,
      battery: data.enginetransmission_battery,
      batteryCharging: data.enginetransmission_battery_charging,
      electricMotor: data.enginetransmission_electric_motor,
      engineOthers: data.enginetransmission_others,
      alternateFuel: data.enginetransmission_alternatefuel,
      ...
      frontSuspension: data.suspension_brakes_steeringandtyres_front_suspension,
      ...
      minimumTurningRadius: data.suspension_brakes_steeringandtyres_minimum_turning_radius,
      steeringType: data.suspension_brakes_steeringandtyres_steering_type,
      ...
      fourWheelSteering: data.suspension_brakes_steeringandtyres_four_wheel_steering,
      brakingPerformance: data.suspension_brakes_steeringandtyrees_braking_performance,
      ...
      highBeamAssist: data.safety_high_beam_assist,
      ncapRating: data.safety_ncap_rating,
      blindSpotDetection: data.safety_blind_spot_detection,
      laneDeparturePrevention: data.safety_lane_departure_prevention,
      punctureRepairKit: data.safety_puncture_repair_kit,
      crossTrafficAssist: data.safety_cross_traffic_assist,
      airbags: data.safety_airbags,
      middleRearThreePointSeatbelt: data.safety_middle_rear_three_point_seatbelt,
      middleRearHeadrest: data.safety_middle_rear_heardest,
      tyrePressureMonitoringSystem: data.safety_tyre_pressure_monitoring_system_tpms,
      childSeatAnchorPoints: data.safety_child_seat_anchor_points,
      ...
      electronicBrakeforceDistributionEbd: data.barking_and_traction_electronic_brakeforce_distribution_ebd,
      brakeAssistBa: data.barking_and_traction_brake_assist_ba,
      electronicStabilityProgram: data.barking_and_traction_electronic_stability_program,
      fourWheelDrive: data.barking_and_traction_four_wheel_drive,
      hillHoldControl: data.barking_and_traction_hill_hold_control,
      tractionControlSystem: data.barking_and_traction_traction_control_system_tc_tcs,
      rideHeightAdjustment: data.barking_and_traction_ride_height_adjustment,
      hillDescentControl: data.barking_and_traction_hill_descent_control,
      limitedSlipDifferential: data.barking_and_traction_limited_slip_differential_lsd,
      differentialLock: data.barking_and_traction_differential_lock,

      // Locks & Security
      engineImmobilizer: data.locks_and_security_engine_immobilizer,
      ...
      rearAc: data.comfort_and_convenience_rear_ac,
      headlightIgnitionOnReminder: data.comfort_and_conv_headlight_and_ignition_on_reminder,
      keylessStartButtonStart: data.comfort_and_convenience_keyless_start_button_start,
      steeringAdjustment: data.comfort_and_convenience_steering_adjustment,
      powerOutlets12v: data.comfort_and_convenience_12v_power_outlets,
      cruiseControl: data.comfort_and_convenience_cruise_control,
      parkingSensors: data.comfort_and_convenience_parking_sensors,
      parkingAssist: data.comfort_and_convenience_parking_assist,
      antiglareMirrors: data.comfort_and_convenience_antiglare_mirrors,
      vanityMirrorsOnSunvisors: data.comfort_and_convenience_vanity_mirrors_on_sunvisors,
      heater: data.comfort_and_convenience_heater,
      cabinBootAccess: data.comfort_and_convenience_cabin_bootaccess,
      thirdRowAc: data.comfort_and_convenience_third_row_ac,

      // Telematics
      remoteCarLightFlashingHonkingViaApp: data.telematics_remote_car_light_flashing_and_honking_via_app,
      geofence: data.telematics_geofence,
      remoteSunroofOpenCloseViaApp: data.telematics_remote_sunroof_open_close_via_app,
      overTheAirUpdatesOta: data.telematics_over_the_air_updates_ota,
      ...
      emergencyCall: data.telematics_emergency_call,
      findMyCar: data.telematics_find_my_car,
      remoteAcOnOffViaApp: data.telematics_remote_ac_on_off_via_app,
      alexaCompatibility: data.telematics_alexa_compatibility,

      // Seats & Upholstery
      driverSeatAdjustment: data.seats_and_upholstery_driver_seat_adjustment,
      frontPassengerSeatAdjustment: data.seats_and_upholstery_front_passenger_seat_adjustment,
      rearRowSeatAdjustment: data.seats_and_upholstery_rear_row_seat_adjustment,
      thirdRowSeatAdjustment: data.seats_and_upholstery_third_row_seat_adjustment,
      seatUpholstery: data.seats_and_upholstery_seat_upholstery,
      leatherWrappedSteeringWheel: data.seats_and_upholstery_leather_wrapped_steering_wheel,
      leatherWrappedGearKnob: data.seats_and_upholstery_leather_wrapped_gear_knob,
      driverArmsrest: data.seats_and_upholstery_driver_armrest,
      rearPassengerSeatsType: data.seats_and_upholstery_rear_passenger_seats_type,
      thirdRowSeatsType: data.seats_and_upholstery_third_row_seats_type,
      ventilatedSeats: data.seats_and_upholstery_ventilated_seats,
      ventilatedSeatType: data.seats_and_upholstery_ventilated_seat_type,
      interiors: data.seats_and_upholstery_interiors,
      interiorsColours: data.seats_and_upholstery_interiors_colours,
      rearArmrest: data.seats_and_upholstery_rear_armrest,
      foldingRearSeat: data.seats_and_upholstery_folding_rear_seat,
      splitRearSeat: data.seats_and_upholstery_split_rear_seat,
      splitThirdRowSeat: data.seats_and_upholstery_split_third_row_seat,
      frontSeatPocket: data.seats_and_upholstery_front_seat_pocket,
      headrests: data.seats_and_upholstery_headrests,
      fourthRowSeatAdjustment: data.seats_and_upholstery_fourth_row_seat_adjustment,

      // Storage
      cupHolders: data.storage_cup_holders,
      driverArmrestStorage: data.storage_driver_armrest_storage,
      cooledGloveBox: data.storage_cooled_glove_box,
      sunglassHolder: data.storage_sunglass_holder,
      thirdRowCupHolders: data.storage_third_row_cup_holders,

      // Doors, Windows, Mirrors & Wipers
      oneTouchDown: data.doors_windows_mirrors_wipers_one_touch_down,
      oneTouchUp: data.doors_windows_mirrors_wipers_one_touch_up,
      powerWindows: data.doors_windows_mirrors_wipers_power_windows,
      adjustableOrvm: data.doors_windows_mirrors_wipers_adjustable_orvm,
      turnIndicatorsOnOrvm: data.doors_windows_mirrors_wipers_turn_indicators_on_orvm,
      rearDefogger: data.doors_windows_mirrors_wipers_rear_defogger,
      rearWiper: data.doors_windows_mirrors_wipers_rear_wiper,
      exteriorDoorHandles: data.doors_windows_mirrors_wipers_exterior_door_handles,
      rainSensingWipers: data.doors_windows_mirrors_wipers_rain_sensing_wipers,
      interiorDoorHandles: data.doors_windows_mirrors_wipers_interior_door_handles,
      exteriorDoorPockets: data.doors_windows_mirrors_wipers_exterior_door_pockets,
      sideWindowBlinds: data.doors_windows_mirrors_wipers_side_window_blinds,
      bootlidOpener: data.doors_windows_mirrors_wipers_bootild_opener,
      rearWindshieldBlind: data.doors_windows_mirrors_wipers_rear_windshield_blind,
      outsideRearviewMirrorsOrvms: data.doors_windows_mirrors_wipers_outside_rearview_mirrors_orvms,
      scuffPlates: data.doors_windows_mirrors_wipers_scuff_plates,

      // Exterior
      sunroofMoonroof: data.exterior_sunroof_moonroof,
      roofRails: data.exterior_roof_rails,
      roofMountedAntenna: data.exterior_roof_mounted_antenna,
      bodyColouredBumpers: data.exterior_body_coloured_bumpers,
      chromeFinishExhaustPipe: data.exterior_chrome_finish_exhaust_pipe,
      bodyKit: data.exterior_body_kit,
      rubStrips: data.exterior_rub_strips,

      // Lighting
      fogLights: data.lighting_fog_lights,
      daytimeRunningLights: data.lighting_daytime_running_lights,
      headlights: data.lighting_headlights,
      automaticHeadLamps: data.lighting_automatic_head_lamps,
      followMeHomeHeadlamps: data.lighting_followme_home_headlamps,
      tailLights: data.lighting_tail_lights,
      cabinLamps: data.lighting_cabin_lamps,
      headlightHeightAdjuster: data.lighting_headlight_height_adjuster,
      gloveBoxLamp: data.lighting_glove_box_lamp,
      lightsOnVanityMirrors: data.lighting_lights_on_vanity_mirrors,
      rearReadingLamp: data.lighting_rear_reading_lamp,
      corneringHeadlights: data.lighting_cornering_headlights,
      puddleLamps: data.lighting_puddle_lamps,
      ambientInteriorLighting: data.lighting_ambient_interior_lighting,

      // Instrumentation
      instrumentCluster: data.instrumentation_instrument_cluster,
      tripMeter: data.instrumentation_trip_meter,
      averageFuelConsumption: data.instrumentation_average_fuel_consumption,
      averageSpeed: data.instrumentation_average_speed,
      distanceToEmpty: data.instrumentation_distance_to_empty,
      clock: data.instrumentation_clock,
      ...
      headsUpDisplayHud: data.instrumentation_headsupdisplay_hud,
      tachometer: data.instrumentation_techometer,
      instantaneousConsumption: data.instrumentation_instantaneous_consumption,

      // Entertainment, Info & Communication
      smartConnectivity: data.ent_info_comm_smart_connectivity,
      integratedIndashMusicSystem: data.ent_info_comm_integrated_indash_musicsystem,
      headunitSize: data.ent_info_comm_headunit_size,
      display: data.ent_info_comm_display,
      displayScreenForRearPassengers: data.ent_info_comm_display_screen_for_rear_passengers,
      gpsNavigationSystem: data.ent_info_comm_gps_navigation_system,
      ...
      mp3Playback: data.ent_info_comm_mp3_playback,
      cdPlayer: data.ent_info_comm_cd_player,
      dvdPlayback: data.ent_info_comm_dvd_playback,
      amFmRadio: data.ent_info_comm_am_fm_radio,
      ipodCompatibility: data.ent_info_comm_ipod_compatibility,
      internalHardDrive: data.ent_info_comm_internal_hard_drive,
      steeringMountedControls: data.ent_info_comm_steering_mounted_controls,
      voiceCommand: data.ent_info_comm_voice_command,
      wirelessCharger: data.ent_info_comm_wireless_charger,
      gestureControl: data.ent_info_comm_gesture_control,

      // Rear Row Seat
      rearRowSeatBaseSliding: data.rear_row_seat_base_sliding,

      // Manufacturer Warranty
      warrantyInYears: data.manufacturer_warranty_warranty_in_years,
      warrantyInKms: data.manufacturer_warranty_warranty_in_kms,
      batteryWarrantyInYears: data.manufacturer_warranty_battery_warranty_in_years,
      batteryWarrnatyInKms: data.manufacturer_warranty_battery_warranty_in_kms,

      // Price Breakdown
      exShowroomPrice: data.price_breakdown_ex_showroom_price,
      rto: data.price_breakdown_rto,
      insurance: data.price_breakdown_insurance,
      taxCollectedAtSourceTcs: data.price_breakdown_tax_collected_at_source_tcs,
      handlingLogisticCharges: data.price_breakdown_handling_logistic_charges,
      fastTag: data.price_breakdown_fast_tag,

      // On Road Price by City
      onRoadPriceMumbai: data.on_road_price_by_city_mumbai,
      onRoadPriceBangalore: data.on_road_price_by_city_bangalore,
      onRoadPriceDelhi2: data.on_road_price_by_city_delhi,
      onRoadPricePune: data.on_road_price_by_city_pune,
      onRoadPriceNaviMumbai: data.on_road_price_by_city_navi_mumbai,
      onRoadPriceHyderabad: data.on_road_price_by_city_hyderabad,
      onRoadPriceAhmedabad: data.on_road_price_by_city_Ahmedabad,
      onRoadPriceChennai: data.on_road_price_by_city_chennai,
      onRoadPriceKolkata: data.on_road_price_by_city_kolkata,
